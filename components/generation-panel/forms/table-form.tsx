    ...
    <div className="space-y-4">
      ...
      <CollapsibleSection title="Structure" isOpen={showStructure} onToggle={() => setShowStructure(!showStructure)}>
        <div className="space-y-3">
          ...
          {/* Column Widths */}
          <div className="space-y-1.5">
            <label className="text-[10px] text-gray-500 font-medium">Column Widths (%)</label>
              ...
              {columnWidths.map((w, i) => (
                <div key={i} className="space-y-0.5">
                  ...
                  <input
                    ...
                    className="w-full px-1.5 py-0.5 rounded bg-gray-700/50 border border-gray-600 text-[10px] text-gray-100"
                  />
                </div>
              ))}
            </div>
      ...
      <CollapsibleSection title="Styling" isOpen={showStyling} onToggle={() => setShowStyling(!showStyling)}>
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-gray-500 font-medium">Header Char Limits</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-gray-500 font-medium">Cell Char Limits</label>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <label className="text-[10px] text-gray-500">Min</label>
